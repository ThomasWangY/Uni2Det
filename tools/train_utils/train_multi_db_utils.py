    ...
    if hook_config is not None:
        ...
        if DisableAugmentationHook is not None:
            ...
            if (total_epochs - num_last_epochs) <= cur_epoch and not flag:
                ...
                dataset_cfg_1,dataset_cfg_2=cfg.DATA_CONFIG,cfg.DATA_CONFIG_SRC_2
                dataset_cfg_1.DATA_AUGMENTOR.DISABLE_AUG_LIST = DISABLE_AUG_LIST
                dataset_cfg_2.DATA_AUGMENTOR.DISABLE_AUG_LIST = DISABLE_AUG_LIST
                disable_id = DisableAugmentationHook.get('DISABLEID', None)
                if disable_id is None:
                    dataloader_1._dataset.data_augmentor.disable_augmentation(dataset_cfg_1.DATA_AUGMENTOR)
                    dataloader_2._dataset.data_augmentor.disable_augmentation(dataset_cfg_2.DATA_AUGMENTOR)
                elif disable_id == 1:
                    dataloader_1._dataset.data_augmentor.disable_augmentation(dataset_cfg_1.DATA_AUGMENTOR)
                elif disable_id == 2:
                    dataloader_2._dataset.data_augmentor.disable_augmentation(dataset_cfg_2.DATA_AUGMENTOR) 
