...
class DataProcessor(object):
    ...
    def mask_points_and_boxes_outside_range_(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.mask_points_and_boxes_outside_range_, config=config)

        self.point_cloud_range = config.RANGE
